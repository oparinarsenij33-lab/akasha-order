...
// 🔥 BOOK CREATION WITH COVER AND FILE UPLOAD
...
window.addUserStatus = async function(userKey) { 
    ...
    if (!newStatus || newStatus === '') { showAlert('Ошибка', 'Выберите статус из списка!'); return; } 
...
window.addUserTitle = async function(userKey) { 
    ...
    if (!newTitle || newTitle === '') { showAlert('Ошибка', 'Выберите звание из списка!'); return; } 
